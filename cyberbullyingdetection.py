...
class CyberbullyingDetectionEngine:
    """ Class that deals with training and cyberbullying detection models
    """
    ...
    def _simplify(self, corpus):
        """ Takes in a list of strings (corpus) and removes stopwords, converts to lowercase, 
    ...
    def load_corpus(self, path, corpus_col, tag_col):
        """ Takes in a path to pickled pandas dataframe, the name of corpus column,
    ...
    def load_lexicon(self, fname):
        """ Loads a set of words fro ma text file
        """
    ...
    def save_model(self, model_name):
        ...
        """
        pickle_dump(self.model, open('./models/' + model_name + '_ml_model.pkl', 'wb'))
        pickle_dump(self.vectorizer, open('./models/' + model_name + '_vectorizer.pkl', 'wb'))
        pickle_dump(self.metrics, open('./models/' + model_name + '_metrics.pkl', 'wb'))

if __name__ == '__main__':
    reddit = praw.Reddit(
        client_id = 'qxu4Vi3_1dBSKQ',
        client_secret = 'x789tyVyTtvf4rXurQGrdkHf8xU',
        user_agent = 'coffee n code cyberbullying model'
    )
